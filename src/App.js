...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/DashboardTasks" element={<DashboardTasks tasks={tasks} addTask={addTask} updateTaskDone={updateTaskDone} removeTask={removeTask} renameTask={renameTask} editDescription={editDescription} numberComplete={numberComplete} totalNumber={totalNumber} />} />
    </Routes>
  </Router>
);
}
